...
from app.users.views import UserAPIList, UserRegisterAPI, MyTokenObtainPairView, Send_emailView, TaskStatusApiView
...
urlpatterns = [
    ...
    path('send_email', Send_emailView.as_view(), name='email')
